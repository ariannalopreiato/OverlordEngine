...
void MinionScene::Update()
{
	...
	/*m_pTorusBig->GetTransform()->Rotate(XMFLOAT3(0, rotation, 0), true);
	m_pTorusMiddle->GetTransform()->Rotate(XMFLOAT3(rotation, 0, 0), true);
	m_pTorusSmall->GetTransform()->Rotate(XMFLOAT3(0, rotation, 0), true);*/
